...
//テンプレ作成
let template = "// Automatically generated by ./color-picker.js\n\n$skin-name: \"<%- skin_name -%>\";\n$skin-colors: (<%- editor_colors -%>);";

//skin.jsonを読み込み
const skin_json = JSON.parse(fs.readFileSync('./skin.json', 'utf8'));
...
fs.writeFileSync('./src/scss/_skin_config.scss',scss);
